  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-orange-50 to-pink-50 relative overflow-hidden">
          {/* Animated background elements */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-orange-400/20 to-pink-400/20 rounded-full blur-3xl animate-float-slow"></div>
            <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-purple-400/20 to-blue-400/20 rounded-full blur-3xl animate-float-reverse"></div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl relative z-10 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-orange-600 via-pink-600 to-purple-600 bg-clip-text text-transparent drop-shadow-lg leading-tight">
            ...
            <p className="text-xl sm:text-2xl text-gray-700 mb-8 max-w-4xl mx-auto leading-relaxed">
              We're on a mission to democratize <span className="font-bold bg-gradient-to-r from-orange-600 to-pink-600 bg-clip-text text-transparent">AI voice agent technology</span>, making intelligent <span className="font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">AI voice assistants</span> accessible to businesses of all sizes.
            </p>

            {/* Quick Stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {stats.slice(0, 4).map((stat, idx) => (
                <div key={idx} className="bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-xl border-2 border-orange-200 hover:border-orange-400 transition-all hover:scale-105">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white" id="who-we-are">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl sm:text-4xl font-bold text-center mb-16 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-orange-50 via-pink-50 to-purple-50 rounded-3xl p-8 shadow-2xl border-2 border-orange-200">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-blue-50 to-purple-50" id="our-story">
          <div className="container mx-auto max-w-6xl">
              ...
              {milestones.map((milestone, idx) => (
                <div key={idx} className="relative">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1 bg-white rounded-2xl p-6 shadow-xl border-2 border-orange-200 hover:border-orange-400 transition-all hover:scale-[1.02]">
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => (
                <Card
                  key={index}
                  className="group text-center border-2 border-orange-200 hover:border-orange-400 bg-white rounded-3xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all"
                >
                  <CardHeader>
        ...
        {/* CTA Section */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-600 via-pink-600 to-purple-600 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup">
                <Button size="lg" className="bg-white text-orange-600 hover:bg-gray-100 rounded-full px-8 py-6 text-lg font-bold shadow-2xl hover:scale-105 transition-all">
                  Start Free 14-Day Trial
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/contact">
                <Button size="lg" variant="outline" className="bg-transparent border-2 border-white text-white hover:bg-white/10 rounded-full px-8 py-6 text-lg font-bold">
                  Schedule a Demo
                </Button>
              </Link>
            </div>
