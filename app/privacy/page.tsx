        ...
        <main className="flex-1">
          <div className="max-w-5xl mx-auto px-6 py-12">
            ...
            <div className="text-center mb-12 relative">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-200/20 to-pink-200/20 blur-3xl -z-10"></div>
              ...
              <h1 className="text-5xl md:text-6xl font-black mb-4 bg-gradient-to-r from-orange-600 via-orange-500 to-pink-500 bg-clip-text text-transparent">
                Privacy Policy
              </h1>
            ...
            {/* Introduction Card */}
            <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border-l-4 border-orange-500 hover:shadow-2xl transition-shadow duration-300">
              <div className="flex items-start space-x-4">
                <div className="bg-gradient-to-br from-orange-500 to-pink-500 p-3 rounded-2xl shadow-lg shrink-0">
            ...
            <section className="bg-white rounded-3xl shadow-xl p-8 md:p-10 mb-8 border border-orange-100 hover:shadow-2xl transition-all duration-300">
