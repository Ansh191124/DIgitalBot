  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto text-center">
          ...
          <nav className="flex justify-center mb-8" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-2 text-sm bg-black/80 backdrop-blur-md px-6 py-3 rounded-full border-2 border-orange-200 shadow-lg">
              <li>
                <Link href="/" className="text-gray-400 hover:text-orange-600 transition-colors font-medium">
                  Home
                </Link>
              </li>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6">
            ...
            <span className="inline-block px-8 py-4 rounded-2xl text-white bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 shadow-2xl text-3xl sm:text-4xl lg:text-5xl relative overflow-hidden border-2 border-orange-300 animate-gradient">
          ...
          <div className="max-w-4xl mx-auto mb-8 p-6 bg-gradient-to-r from-orange-100 via-orange-200 to-orange-200 border-2 border-orange-400 rounded-2xl shadow-2xl backdrop-blur-md">
            <p className="text-xl sm:text-2xl text-gray-300 leading-relaxed">
              ...
              Trusted by <span className="font-extrabold bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">500+ businesses</span> across <span className="font-extrabold bg-gradient-to-r from-orange-600 to-orange-700 bg-clip-text text-transparent">25+ countries</span> to handle <span className="font-extrabold bg-gradient-to-r from-orange-600 to-orange-600 bg-clip-text text-transparent">2M+ conversations</span> monthly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto mb-12">
            {stats.map((stat, index) => {
              const colors = [
                { border: 'border-orange-400', gradient: 'from-orange-500 to-orange-600', shadow: 'hover:shadow-orange-300', glow1: 'from-orange-400 via-orange-500 to-orange-600', glow2: 'from-orange-400 via-orange-600 to-orange-600' },
                ...
                { border: 'border-orange-400', gradient: 'from-orange-500 to-orange-500', shadow: 'hover:shadow-pink-300', glow1: 'from-orange-400 via-orange-400 to-yellow-400', glow2: 'from-orange-400 via-orange-500 to-orange-600' },
              ];
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-white hover:scale-105 transition-all rounded-xl px-8 py-6 text-lg shadow-2xl hover:shadow-orange-400 border-2 border-orange-300 animate-gradient">
                Start Free Trial
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link href="/pricing">
              <Button variant="outline" className="border-2 border-orange-500 text-white hover:bg-orange-500/20 rounded-xl px-8 py-6 text-lg shadow-lg hover:scale-105 transition-all">
                View Pricing
              </Button>
            </Link>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-orange-300/20 via-orange-500/20 to-pink-300/20 rounded-full filter blur-3xl"></div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6">
              ...
              <span className="inline-block px-6 py-3 rounded-xl text-white bg-gradient-to-r from-orange-400 via-orange-600 to-orange-600 shadow-2xl border-2 border-orange-400">
                Service Suite
              </span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              const borderColors = ['border-orange-300', 'border-orange-400', 'border-orange-400', 'border-orange-400', 'border-teal-300', 'border-orange-400'];
              ...
              const shadowColors = ['hover:shadow-orange-200', 'hover:shadow-orange-200', 'hover:shadow-orange-200', 'hover:shadow-pink-200', 'hover:shadow-teal-200', 'hover:shadow-orange-200'];
              ...
              return (
                <Link key={index} href={service.href}>
                  <Card className={`relative bg-black border-2 ${borderColors[index]} ${hoverBorderColors[index]} rounded-3xl hover:scale-105 ${shadowColors[index]} shadow-xl hover:shadow-2xl transition-all duration-500 h-full group cursor-pointer overflow-hidden`}>
                    ...
                    <div className="absolute -top-4 -left-4 w-14 h-14 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-2xl flex items-center justify-center font-extrabold text-white text-xl shadow-2xl transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 border-2 border-white">
                      {String(index + 1).padStart(2, '0')}
                    </div>

                    {service.popular && (
                      <Badge className="absolute -top-2 right-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-lg animate-pulse border-2 border-white">
                        ⭐ Popular
                      </Badge>
                    )}

                    <CardHeader className="pt-10 pb-4">
                      <div className="w-20 h-20 bg-gradient-to-br from-orange-100 via-orange-200 to-orange-200 rounded-2xl flex items-center justify-center mb-6 mx-auto border-2 border-orange-200 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
                        <service.icon className="h-10 w-10 text-orange-500" />
                      </div>
                      <CardTitle className="text-xl font-bold text-white mb-3 text-center group-hover:bg-gradient-to-r group-hover:from-orange-600 group-hover:to-orange-700 group-hover:bg-clip-text group-hover:text-transparent transition-all">
                        {service.title}
                      </CardTitle>
                    ...
                    <CardContent className="pb-8">
                      <ul className="space-y-3 mb-6">
                        {service.features.map((feature, idx) => (
                          ...
                          >
                            <div className="w-5 h-5 rounded-full bg-gradient-to-r from-orange-400 to-orange-600 flex items-center justify-center mr-3 flex-shrink-0">
                      ...
                      <div className="flex items-center justify-center text-orange-600 group-hover:text-orange-600 transition-colors font-bold pt-4 border-t-2 border-gray-100">
                        Learn More
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            <div className="inline-block mb-6">
              <span className="px-6 py-3 rounded-full bg-gradient-to-r from-orange-400 via-orange-600 to-orange-600 text-white font-bold text-sm uppercase tracking-wider shadow-2xl animate-pulse border-2 border-white">
                🌍 Global Reach
              </span>
            </div>
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6">
              <span className="block mb-2 bg-gradient-to-r from-orange-500 via-orange-700 to-orange-700 bg-clip-text text-transparent">
                Industries We Serve
              </span>
              <span className="inline-block text-gray-300 text-2xl font-semibold">
                Across <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">25+ Countries</span>
              </span>
            </h2>
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {industries.map((industry, index) => {
              const colors = [
                { bg: 'from-orange-100 via-orange-200 to-orange-200', border: 'border-orange-300', hover: 'hover:border-orange-500', icon: 'text-orange-500', shadow: 'hover:shadow-orange-200' },
                { bg: 'from-orange-100 via-orange-200 to-orange-200', border: 'border-orange-400', hover: 'hover:border-orange-500', icon: 'text-orange-500', shadow: 'hover:shadow-orange-200' },
                { bg: 'from-orange-100 via-orange-200 to-orange-100', border: 'border-orange-400', hover: 'hover:border-orange-500', icon: 'text-orange-500', shadow: 'hover:shadow-orange-200' },
                { bg: 'from-orange-100 via-orange-100 to-yellow-100', border: 'border-orange-400', hover: 'hover:border-orange-500', icon: 'text-orange-500', shadow: 'hover:shadow-pink-200' },
                { bg: 'from-teal-100 via-green-100 to-emerald-100', border: 'border-teal-300', hover: 'hover:border-orange-500', icon: 'text-orange-500', shadow: 'hover:shadow-teal-200' },
                { bg: 'from-orange-100 via-orange-200 to-orange-200', border: 'border-orange-400', hover: 'hover:border-orange-500', icon: 'text-orange-500', shadow: 'hover:shadow-orange-200' },
              ];
              const color = colors[index % colors.length];
              ...
              return (
                ...
                >
                  <CardContent className="p-8 text-center relative">
                    ...
                    <h3 className={`text-xl font-bold text-white mb-3 group-hover:bg-gradient-to-r group-hover:${color.bg.replace('100', '600')} group-hover:bg-clip-text group-hover:text-transparent transition-all relative z-10`}>
                      {industry.name}
                    </h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-gradient-to-bl from-orange-300/20 via-orange-500/20 to-pink-300/20 rounded-full filter blur-3xl"></div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6">
              ...
              <span className="inline-block px-8 py-4 rounded-2xl text-white bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 shadow-2xl border-2 border-orange-300">
                Services Work?
              </span>
            </h2>
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              const colors = [
                { gradient: 'from-orange-500 via-orange-600 to-orange-700', border: 'border-orange-300', hover: 'hover:border-orange-500', shadow: 'hover:shadow-orange-200', textGradient: 'from-orange-600 to-orange-700' },
                { gradient: 'from-orange-400 via-orange-600 to-orange-600', border: 'border-orange-400', hover: 'hover:border-orange-500', shadow: 'hover:shadow-orange-200', textGradient: 'from-orange-500 to-orange-600' },
                { gradient: 'from-orange-500 via-orange-600 to-orange-500', border: 'border-orange-400', hover: 'hover:border-orange-500', shadow: 'hover:shadow-orange-200', textGradient: 'from-orange-500 to-orange-600' },
              ];
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-orange-500/30 hover:border-orange-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-orange-500/50">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg rotate-12 group-hover:rotate-0 transition-transform">
                01
              </div>
            ...
            {/* FAQ 2 */}
            <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-orange-500/30 hover:border-orange-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-orange-500/50">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-orange-400 to-orange-500 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg rotate-12 group-hover:rotate-0 transition-transform">
                02
              </div>
      ...
      <section className="py-24 px-6 relative overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black">
        ...
        <div className="container mx-auto relative z-10">
          <div className="bg-black rounded-3xl p-12 md:p-16 border-4 border-orange-300 hover:border-orange-400 shadow-2xl hover:shadow-orange-300 hover:scale-[1.02] transition-all text-center relative overflow-hidden group">
            ...
            <div className="absolute -bottom-20 -right-20 w-60 h-60 bg-gradient-to-tl from-orange-300/20 via-orange-500/20 to-pink-300/20 rounded-full filter blur-3xl group-hover:blur-2xl transition-all"></div>
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-4xl sm:text-5xl font-extrabold mb-6">
                ...
                <span className="inline-block px-8 py-4 rounded-2xl text-white bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 shadow-2xl border-2 border-orange-300 animate-gradient relative">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                <Link href="/contact">
                  <Button className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-white hover:scale-105 transition-all rounded-xl px-10 py-7 text-xl font-bold shadow-2xl hover:shadow-orange-400 border-2 border-orange-300 animate-gradient">
                    Start Free Trial Now
                    <ArrowRight className="ml-2 h-6 w-6" />
                  </Button>
                </Link>
                <Link href="/pricing">
                  <Button variant="outline" className="border-2 border-orange-500 text-white hover:bg-orange-500/20 rounded-xl px-10 py-7 text-xl font-bold shadow-lg hover:scale-105 transition-all">
                    View Pricing Plans
                  </Button>
                </Link>
              </div>
