...
export default function Services() {
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-cyan-400/20 via-teal-500/20 to-cyan-600/20 rounded-full filter blur-3xl animate-float-slow"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-bl from-teal-400/20 via-cyan-600/20 to-teal-600/20 rounded-full filter blur-3xl animate-float-reverse"></div>
        
        <div className="relative z-10 container mx-auto text-center">
          {/* Breadcrumb */}
          <nav className="flex justify-center mb-8" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-2 text-sm bg-black/80 backdrop-blur-md px-6 py-3 rounded-full border-2 border-cyan-200 shadow-lg">
              <li>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6">
            ...
            <span className="inline-block px-8 py-4 rounded-2xl text-white bg-gradient-to-r from-cyan-500 via-teal-500 to-cyan-600 shadow-2xl text-3xl sm:text-4xl lg:text-5xl relative overflow-hidden border-2 border-cyan-300 animate-gradient">
          ...
          <div className="max-w-4xl mx-auto mb-8 p-6 bg-gradient-to-r from-white/10 to-white/5 border-2 border-cyan-400/50 rounded-2xl shadow-2xl backdrop-blur-md">
            <p className="text-xl sm:text-2xl text-gray-300 leading-relaxed">
              ...
              Trusted by <span className="font-extrabold bg-gradient-to-r from-cyan-400 to-teal-500 bg-clip-text text-transparent">500+ businesses</span> across <span className="font-extrabold bg-gradient-to-r from-teal-400 to-cyan-500 bg-clip-text text-transparent">25+ countries</span> to handle <span className="font-extrabold bg-gradient-to-r from-cyan-400 to-cyan-500 bg-clip-text text-transparent">2M+ conversations</span> monthly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto mb-12">
            {stats.map((stat, index) => {
              const colors = [
                { border: 'border-cyan-400', gradient: 'from-cyan-500 to-teal-500', shadow: 'hover:shadow-cyan-300', glow1: 'from-cyan-400 via-teal-500 to-cyan-600', glow2: 'from-teal-400 via-cyan-600 to-teal-600' },
                { border: 'border-teal-400', gradient: 'from-teal-400 to-cyan-500', shadow: 'hover:shadow-teal-300', glow1: 'from-teal-400 via-cyan-600 to-teal-600', glow2: 'from-cyan-400 via-teal-500 to-cyan-400' },
                { border: 'border-cyan-400', gradient: 'from-cyan-400 to-teal-500', shadow: 'hover:shadow-cyan-300', glow1: 'from-cyan-400 via-teal-500 to-cyan-400', glow2: 'from-teal-400 via-cyan-500 to-teal-600' },
                { border: 'border-teal-400', gradient: 'from-teal-500 to-cyan-500', shadow: 'hover:shadow-teal-300', glow1: 'from-teal-400 via-cyan-400 to-teal-400', glow2: 'from-cyan-400 via-teal-500 to-cyan-600' },
              ];
              ...
              return (
                <div
                  key={index}
                  className={`bg-black backdrop-blur-md rounded-2xl p-6 border-2 ${color.border} ${color.shadow} shadow-xl hover:scale-105 transition-all duration-300 relative overflow-hidden group`}
                >
                  ...
                  <div className="text-sm text-gray-300 font-semibold relative z-10">{stat.label}</div>
                </div>
              );
            })}
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button className="bg-gradient-to-r from-cyan-500 via-teal-500 to-cyan-600 text-white hover:scale-105 transition-all rounded-xl px-8 py-6 text-lg shadow-2xl hover:shadow-cyan-400 border-2 border-cyan-300 animate-gradient">
                Start Free Trial
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link href="/pricing">
              <Button variant="outline" className="border-2 border-cyan-500 text-white hover:bg-cyan-500/20 rounded-xl px-8 py-6 text-lg shadow-lg hover:scale-105 transition-all">
                View Pricing
              </Button>
            </Link>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-cyan-300/20 via-teal-500/20 to-cyan-500/20 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-teal-300/20 via-cyan-400/20 to-teal-500/20 rounded-full filter blur-3xl"></div>
        
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            <div className="inline-block mb-6">
              <span className="px-6 py-3 rounded-full bg-gradient-to-r from-cyan-500 via-teal-500 to-cyan-600 text-white font-bold text-sm uppercase tracking-wider shadow-2xl animate-pulse border-2 border-white">
                ⭐ Premium AI Services
              </span>
            </div>
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6">
              <span className="block mb-2 bg-gradient-to-r from-cyan-400 via-teal-400 to-cyan-500 bg-clip-text text-transparent">
                Our AI Voice Assistant
              </span>
              <span className="inline-block px-6 py-3 rounded-xl text-white bg-gradient-to-r from-cyan-500 via-teal-500 to-cyan-600 shadow-2xl border-2 border-cyan-400">
                Service Suite
              </span>
            </h2>
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Choose from our <span className="font-bold text-cyan-400">comprehensive suite</span> of AI-powered voice solutions designed to <span className="font-bold text-teal-400">automate and enhance</span> every aspect of your business communication.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              const borderColors = ['border-cyan-300', 'border-teal-400', 'border-cyan-400', 'border-teal-400', 'border-cyan-300', 'border-teal-400'];
              const hoverBorderColors = ['hover:border-cyan-500', 'hover:border-teal-500', 'hover:border-cyan-500', 'hover:border-teal-500', 'hover:border-cyan-500', 'hover:border-teal-500'];
              const shadowColors = ['hover:shadow-cyan-200', 'hover:shadow-teal-200', 'hover:shadow-cyan-200', 'hover:shadow-teal-200', 'hover:shadow-cyan-200', 'hover:shadow-teal-200'];
              
              return (
                <Link key={index} href={service.href}>
                  <Card className={`relative bg-black border-2 ${borderColors[index]} ${hoverBorderColors[index]} rounded-3xl hover:scale-105 ${shadowColors[index]} shadow-xl hover:shadow-2xl transition-all duration-500 h-full group cursor-pointer overflow-hidden`}>
                    {/* Decorative Glow Effect */}
                    <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-cyan-300/30 via-teal-400/30 to-cyan-300/30 rounded-full filter blur-3xl group-hover:blur-2xl transition-all"></div>
                    
                    {/* Numbered Badge - Enhanced */}
                    <div className="absolute -top-4 -left-4 w-14 h-14 bg-gradient-to-br from-cyan-500 via-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center font-extrabold text-white text-xl shadow-2xl transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 border-2 border-white">
                      {String(index + 1).padStart(2, '0')}
                    </div>

                    {service.popular && (
                      <Badge className="absolute -top-2 right-4 bg-gradient-to-r from-cyan-500 to-teal-500 text-white shadow-lg animate-pulse border-2 border-white">
                        ⭐ Popular
                      </Badge>
                    )}

                    <CardHeader className="pt-10 pb-4">
                      <div className="w-20 h-20 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl flex items-center justify-center mb-6 mx-auto border-2 border-cyan-300/50 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg backdrop-blur-md">
                        <service.icon className="h-10 w-10 text-cyan-400" />
                      </div>
                      <CardTitle className="text-xl font-bold text-white mb-3 text-center group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-teal-500 group-hover:bg-clip-text group-hover:text-transparent transition-all">
                        {service.title}
                      </CardTitle>
                    ...
                    <CardContent className="pb-8">
                      <ul className="space-y-3 mb-6">
                        {service.features.map((feature, idx) => (
                          ...
                          >
                            <div className="w-5 h-5 rounded-full bg-gradient-to-r from-cyan-400 to-teal-500 flex items-center justify-center mr-3 flex-shrink-0">
                      ...
                      <div className="flex items-center justify-center text-cyan-400 group-hover:text-teal-400 transition-colors font-bold pt-4 border-t-2 border-gray-100">
                        Learn More
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            <div className="inline-block mb-6">
              <span className="px-6 py-3 rounded-full bg-gradient-to-r from-cyan-400 via-teal-500 to-cyan-600 text-white font-bold text-sm uppercase tracking-wider shadow-2xl animate-pulse border-2 border-white">
                🌍 Global Reach
              </span>
            </div>
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6">
              <span className="block mb-2 bg-gradient-to-r from-cyan-400 via-teal-500 to-cyan-500 bg-clip-text text-transparent">
                Industries We Serve
              </span>
              <span className="inline-block text-gray-300 text-2xl font-semibold">
                Across <span className="bg-gradient-to-r from-teal-400 to-cyan-500 bg-clip-text text-transparent">25+ Countries</span>
              </span>
            </h2>
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Our AI voice assistants are <span className="font-bold text-cyan-400">trusted across multiple industries</span> to deliver exceptional customer experiences and <span className="font-bold text-teal-400">operational efficiency</span>.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {industries.map((industry, index) => {
              const colors = [
                { bg: 'from-white/10 to-white/5', border: 'border-cyan-300', hover: 'hover:border-cyan-500', icon: 'text-cyan-400', shadow: 'hover:shadow-cyan-200' },
                { bg: 'from-white/10 to-white/5', border: 'border-teal-400', hover: 'hover:border-teal-500', icon: 'text-teal-400', shadow: 'hover:shadow-teal-200' },
                { bg: 'from-white/10 to-white/5', border: 'border-cyan-400', hover: 'hover:border-cyan-500', icon: 'text-cyan-400', shadow: 'hover:shadow-cyan-200' },
                { bg: 'from-white/10 to-white/5', border: 'border-teal-400', hover: 'hover:border-teal-500', icon: 'text-teal-400', shadow: 'hover:shadow-teal-200' },
                { bg: 'from-teal-100/10 via-green-100/5 to-emerald-100/5', border: 'border-teal-300', hover: 'hover:border-teal-500', icon: 'text-teal-400', shadow: 'hover:shadow-teal-200' },
                { bg: 'from-white/10 to-white/5', border: 'border-cyan-400', hover: 'hover:border-cyan-500', icon: 'text-cyan-400', shadow: 'hover:shadow-cyan-200' },
              ];
              const color = colors[index % colors.length];
              ...
              return (
                <Card
                  key={index}
                  className={`bg-black border-2 ${color.border} ${color.hover} rounded-2xl hover:scale-105 shadow-lg ${color.shadow} hover:shadow-2xl transition-all duration-300 group overflow-hidden`}
                >
                  <CardContent className="p-8 text-center relative">
                    <div className="absolute -top-10 -right-10 w-32 h-32 bg-gradient-to-br from-cyan-200/30 via-teal-300/30 to-cyan-200/30 rounded-full filter blur-2xl group-hover:blur-xl transition-all"></div>
                    ...
                    <h3 className={`text-xl font-bold text-white mb-3 group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-teal-500 group-hover:bg-clip-text group-hover:text-transparent transition-all relative z-10`}>
                      {industry.name}
                    </h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
        ...
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-gradient-to-br from-cyan-300/20 via-teal-400/20 to-cyan-500/20 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-gradient-to-bl from-teal-300/20 via-cyan-500/20 to-teal-500/20 rounded-full filter blur-3xl"></div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold mb-6">
              ...
              <span className="inline-block px-8 py-4 rounded-2xl text-white bg-gradient-to-r from-cyan-500 via-teal-500 to-cyan-600 shadow-2xl border-2 border-cyan-300">
                Services Work?
              </span>
            </h2>
            <p className="text-lg text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Get started in <span className="font-bold text-cyan-400">three simple steps</span> and transform your business communication with <span className="font-bold text-teal-400">AI voice technology</span>.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              const colors = [
                { gradient: 'from-cyan-500 via-teal-500 to-cyan-600', border: 'border-cyan-300', hover: 'hover:border-cyan-500', shadow: 'hover:shadow-cyan-200', textGradient: 'from-cyan-400 to-teal-500' },
                { gradient: 'from-teal-400 via-cyan-500 to-teal-600', border: 'border-teal-400', hover: 'hover:border-teal-500', shadow: 'hover:shadow-teal-200', textGradient: 'from-teal-400 to-cyan-500' },
                { gradient: 'from-cyan-500 via-teal-500 to-cyan-500', border: 'border-cyan-400', hover: 'hover:border-cyan-500', shadow: 'hover:shadow-cyan-200', textGradient: 'from-cyan-400 to-teal-500' },
              ];
              ...
              return (
                <div
                  key={idx}
                  className={`relative bg-black rounded-3xl p-10 border-2 ${color.border} ${color.hover} hover:scale-105 ${color.shadow} shadow-xl hover:shadow-2xl transition-all duration-500 group overflow-hidden`}
                >
                  {/* Decorative Glow */}
                  <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-cyan-300/30 via-teal-400/30 to-cyan-300/30 rounded-full filter blur-3xl group-hover:blur-2xl transition-all"></div>
                  
                  {/* Step Number Badge - Enhanced */}
                  <div className={`absolute -top-6 left-1/2 -translate-x-1/2 w-16 h-16 bg-gradient-to-br ${color.gradient} rounded-2xl flex items-center justify-center font-extrabold text-white text-2xl shadow-2xl transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 border-4 border-white`}>
                    {item.step}
                  </div>

                  <div className="pt-12 relative z-10">
                    <h3 className={`text-2xl font-extrabold text-white mb-4 text-center group-hover:bg-gradient-to-r group-hover:${color.textGradient} group-hover:bg-clip-text group-hover:text-transparent transition-all`}>
                      {item.title}
                    </h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 relative overflow-hidden" role="region" aria-labelledby="faq-section">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-cyan-500/20 to-teal-500/20 rounded-full filter blur-3xl animate-float-slow"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-br from-teal-400/20 to-cyan-600/20 rounded-full filter blur-3xl animate-float-reverse"></div>
          <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-gradient-to-br from-cyan-500/20 to-teal-600/20 rounded-full filter blur-3xl animate-pulse"></div>
        </div>

        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-16">
            <div className="inline-block mb-6">
              <span className="px-6 py-2 rounded-full bg-gradient-to-r from-cyan-500 via-teal-500 to-cyan-600 text-white font-bold text-sm uppercase tracking-wider shadow-2xl animate-pulse">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-cyan-500/30 hover:border-cyan-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-cyan-500/50">
              ...
              <h3 className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-teal-500 bg-clip-text text-transparent mb-4 mt-2">
            ...
            <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-teal-500/30 hover:border-teal-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-teal-500/50">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg rotate-12 group-hover:rotate-0 transition-transform">
                02
              </div>
              <h3 className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-teal-500 bg-clip-text text-transparent mb-4 mt-2">
            ...
            {/* FAQ 3 */}
            <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-cyan-500/30 hover:border-teal-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-cyan-500/50">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-cyan-400 to-teal-500 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg rotate-12 group-hover:rotate-0 transition-transform">
                03
              </div>
              <h3 className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-teal-500 bg-clip-text text-transparent mb-4 mt-2">
            ...
            {/* FAQ 4 */}
            <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-teal-500/30 hover:border-cyan-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-teal-500/50">
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg rotate-12 group-hover:rotate-0 transition-transform">
                04
              </div>
              <h3 className="text-xl font-bold bg-gradient-to-r from-teal-500 to-cyan-600 bg-clip-text text-transparent mb-4 mt-2">
            ...
            <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-teal-500/30 hover:border-cyan-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-teal-500/50">
              ...
              <h3 className="text-xl font-bold bg-gradient-to-r from-teal-400 to-cyan-500 bg-clip-text text-transparent mb-4 mt-2">
            ...
            <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-cyan-500/30 hover:border-teal-400 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-cyan-500/50">
              ...
              <h3 className="text-xl font-bold bg-gradient-to-r from-cyan-500 to-teal-600 bg-clip-text text-transparent mb-4 mt-2">
      ...
      <section className="py-24 px-6 relative overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black">
        {/* Decorative Background Elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-5">
          <div className="absolute inset-0" style={{
        ...
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-cyan-400/30 via-teal-500/30 to-cyan-600/30 rounded-full filter blur-3xl animate-float-slow"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-teal-400/30 via-cyan-500/30 to-teal-600/30 rounded-full filter blur-3xl animate-float-reverse"></div>
        
        <div className="container mx-auto relative z-10">
          <div className="bg-black rounded-3xl p-12 md:p-16 border-4 border-cyan-300 hover:border-teal-400 shadow-2xl hover:shadow-cyan-300 hover:scale-[1.02] transition-all text-center relative overflow-hidden group">
            {/* Decorative Inner Glow */}
            <div className="absolute -top-20 -left-20 w-60 h-60 bg-gradient-to-br from-cyan-300/20 via-teal-400/20 to-cyan-500/20 rounded-full filter blur-3xl group-hover:blur-2xl transition-all"></div>
            <div className="absolute -bottom-20 -right-20 w-60 h-60 bg-gradient-to-tl from-teal-300/20 via-cyan-500/20 to-teal-300/20 rounded-full filter blur-3xl group-hover:blur-2xl transition-all"></div>
            
            <div className="relative z-10">
              <div className="inline-block mb-6">
                <span className="px-6 py-3 rounded-full bg-gradient-to-r from-cyan-500 via-teal-600 to-cyan-700 text-white font-bold text-sm uppercase tracking-wider shadow-2xl animate-pulse border-2 border-white">
                  Limited Time Offer
                </span>
              </div>
              
              <h2 className="text-4xl sm:text-5xl font-extrabold mb-6">
                <span className="block mb-3 bg-gradient-to-r from-cyan-600 via-teal-600 to-cyan-700 bg-clip-text text-transparent">
                  Ready to Transform Your
                </span>
                <span className="inline-block px-8 py-4 rounded-2xl text-white bg-gradient-to-r from-cyan-500 via-teal-600 to-cyan-700 shadow-2xl border-2 border-cyan-300 animate-gradient relative">
              ...
              <div className="max-w-2xl mx-auto mb-8 p-6 bg-gradient-to-r from-cyan-100 via-teal-200 to-cyan-200 border-2 border-cyan-300 rounded-2xl">
                <p className="text-lg text-gray-300 leading-relaxed font-medium">
                  Join <span className="font-extrabold bg-gradient-to-r from-cyan-600 to-teal-700 bg-clip-text text-transparent">500+ businesses</span> already using DigitalBot.ai to handle <span className="font-extrabold bg-gradient-to-r from-teal-600 to-cyan-700 bg-clip-text text-transparent">millions of customer conversations</span> with AI voice technology. <span className="font-bold text-cyan-600">Start your free trial today</span>.
                </p>
              </div>
              
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                <Link href="/contact">
                  <Button className="bg-gradient-to-r from-cyan-500 via-teal-600 to-cyan-700 text-white hover:scale-105 transition-all rounded-xl px-10 py-7 text-xl font-bold shadow-2xl hover:shadow-cyan-400 border-2 border-cyan-300 animate-gradient">
                    Start Free Trial Now
                    <ArrowRight className="ml-2 h-6 w-6" />
                  </Button>
                </Link>
                <Link href="/pricing">
                  <Button variant="outline" className="border-2 border-teal-500 text-white hover:bg-teal-500/20 rounded-xl px-10 py-7 text-xl font-bold shadow-lg hover:scale-105 transition-all">
                    View Pricing Plans
                  </Button>
                </Link>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 text-gray-400 text-sm mt-8">
                <span className="inline-flex items-center gap-2">
                  <span className="w-3 h-3 rounded-full bg-gradient-to-r from-cyan-500 to-teal-600 animate-pulse"></span>
                  <span className="font-semibold text-gray-300">No Credit Card Required</span>
                </span>
                <span className="text-gray-400">•</span>
                <span className="inline-flex items-center gap-2">
                  <span className="w-3 h-3 rounded-full bg-gradient-to-r from-teal-400 to-cyan-600 animate-pulse"></span>
                  <span className="font-semibold text-gray-300">Cancel Anytime</span>
                </span>
                <span className="text-gray-400">•</span>
                <span className="inline-flex items-center gap-2">
                  <span className="w-3 h-3 rounded-full bg-gradient-to-r from-cyan-400 to-teal-600 animate-pulse"></span>
