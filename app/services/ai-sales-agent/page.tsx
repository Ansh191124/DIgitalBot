  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-wrap gap-6 justify-center items-center">
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-green-200">
                  ...
                  <span className="text-sm font-medium text-gray-700">500+ Active Businesses</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-blue-200">
                  <TrendingUp className="w-5 h-5 text-blue-600" />
                  <span className="text-sm font-medium text-gray-700">2M+ Sales Conversations</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-purple-200">
                  ...
                  <span className="text-sm font-medium text-gray-700">45% Higher Conversion</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative py-24 overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" role="region" aria-labelledby="faq-section">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 id="faq-section" className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-orange-400 via-pink-400 to-purple-400 text-transparent bg-clip-text">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap gap-8 justify-center items-center">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-blue-200">
                  ...
                  <span className="text-sm font-medium text-gray-700">Setup in 7 Days</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-purple-200">
