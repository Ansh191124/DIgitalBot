  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-b from-white via-orange-100 to-white py-20 md:py-32">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-black rounded-full px-5 py-2 mb-8 border-2 border-orange-300 shadow-lg">
              ...
              <div className="flex flex-wrap gap-6 justify-center items-center">
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-orange-200">
                  ...
                  <span className="text-sm font-medium text-black-300">500+ Active Businesses</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-orange-400">
                  ...
                  <span className="text-sm font-medium text-black-300">2M+ Sales Conversations</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-orange-400">
                  <Zap className="w-5 h-5 text-orange-600" />
                  <span className="text-sm font-medium text-black-300">45% Higher Conversion</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-b from-white via-orange-100 to-white">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-black rounded-full px-5 py-2.5 mb-6 border-2 border-orange-300 shadow-lg">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-center">
                  <button
                    ...
                    className="group relative flex items-center gap-3 px-8 py-3 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-black rounded-full shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden"
                  >
        ...
        <section className="relative py-24 overflow-hidden bg-gradient-to-br from-white via-orange-100 to-white" role="region" aria-labelledby="faq-section">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-6">
              ...
              <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/20 hover:border-orange-400/50 transition-all duration-500 hover:shadow-2xl hover:shadow-orange-500/20">
                <div className="flex gap-6">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-br from-orange-400 to-orange-500 rounded-xl flex items-center justify-center text-black font-bold text-lg shadow-lg rotate-12 group-hover:rotate-0 transition-transform duration-500">
                      2
                    </div>
                  </div>
                  <div className="flex-1">
              ...
              <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/20 hover:border-orange-400/50 transition-all duration-500 hover:shadow-2xl hover:shadow-orange-500/20">
                <div className="flex gap-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-3 bg-gradient-to-r from-orange-300 to-orange-400 text-transparent bg-clip-text">
              ...
              <div className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/20 hover:border-orange-400/50 transition-all duration-500 hover:shadow-2xl hover:shadow-orange-500/20">
                <div className="flex gap-6">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center text-black font-bold text-lg shadow-lg rotate-12 group-hover:rotate-0 transition-transform duration-500">
                      4
                    </div>
                  </div>
                  <div className="flex-1">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap gap-8 justify-center items-center">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-orange-400">
                  <Check className="w-5 h-5 text-orange-600" />
                  <span className="text-sm font-medium text-black-300">Setup in 7 Days</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-orange-400">
                  <Check className="w-5 h-5 text-orange-600" />
