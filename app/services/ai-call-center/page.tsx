    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white py-16 md:py-24">
          ...
          <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-radial from-orange-400/10 to-transparent rounded-full blur-3xl animate-pulse" />
          <div className="absolute top-40 right-20 w-96 h-96 bg-gradient-radial from-orange-300/8 to-transparent rounded-full blur-3xl animate-pulse delay-300" />
          <div className="absolute bottom-20 left-1/3 w-80 h-80 bg-gradient-radial from-orange-500/5 to-transparent rounded-full blur-3xl animate-pulse delay-700" />

          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-orange-500 text-white border border-orange-500 px-6 py-2.5 mb-8 font-semibold text-sm uppercase tracking-widest" style={{
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-8 leading-tight">
                <span className="bg-gradient-to-r from-orange-500 via-orange-400 to-orange-600 bg-clip-text text-transparent uppercase tracking-wider">
                ...
                <span className="relative inline-block mt-2">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400/10 via-orange-300/10 to-orange-500/10 blur-2xl -z-10 scale-110" />
                </span>
              </h1>

              <p className="text-sm sm:text-base md:text-lg mb-10 text-gray-700 max-w-4xl mx-auto leading-relaxed">
                Deploy an <strong className="text-orange-600">AI call center</strong> that handles unlimited customer calls 24/7 with intelligent routing, real-time analytics, and seamless CRM integration.
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <button className="bg-orange-500 text-white hover:bg-orange-400 font-bold px-8 py-3 text-sm tracking-widest uppercase transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-400/30 flex items-center" style={{
                ...
                <button className="bg-white text-orange-600 border-2 border-orange-400/30 hover:bg-orange-50 font-bold px-8 py-3 text-sm tracking-widest uppercase transition-all" style={{
                  clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))'
                }}>
              ...
              <div className="inline-flex flex-col gap-4 bg-white border border-orange-200 p-6 shadow-lg shadow-orange-100/20" style={{
                clipPath: 'polygon(0 0, calc(100% - 15px) 0, 100% 15px, 100% 100%, 15px 100%, 0 calc(100% - 15px))'
              }}>
                <div className="flex flex-wrap gap-6 justify-center items-center text-xs sm:text-sm font-medium">
                  <div className="flex items-center gap-2 text-orange-600 uppercase tracking-widest">
        ...
        <section className="py-16 bg-gray-50 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-orange-500 text-white border border-orange-500 px-4 py-2 mb-6 font-semibold text-xs uppercase tracking-widest" style={{
                clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))'
              }}>
                <Bot className="w-3 h-3 animate-pulse" />
                AI Call Center Features
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent uppercase tracking-wider leading-tight">
              ...
              <p className="text-sm sm:text-base text-gray-700 max-w-3xl mx-auto leading-relaxed">
                Powerful automation, intuitive operations, and <strong className="text-orange-600">measurable outcomes</strong> for modern contact centers
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
              {benefits.map((benefit, index) => (
                <div
                  key={index}
                  className="group relative bg-white border border-orange-200 p-6 hover:border-orange-400 shadow-md hover:shadow-lg hover:shadow-orange-200/50 transition-all duration-500 hover:-translate-y-2"
                  style={{
                    clipPath: 'polygon(0 0, calc(100% - 12px) 0, 100% 12px, 100% 100%, 12px 100%, 0 calc(100% - 12px))'
                  }}
                >
                  {/* HD Image */}
                  <div className="relative w-full h-24 mb-4 overflow-hidden border border-orange-200" style={{
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-b from-orange-900/10 to-white/20"></div>
                    <div className="absolute bottom-2 left-2">
                      <div className="w-8 h-8 bg-orange-500 flex items-center justify-center text-white" style={{
                  ...
                  <h3 className="text-lg font-bold mb-3 text-orange-600 group-hover:text-orange-700 transition-colors uppercase tracking-wider leading-tight">
                    {benefit.title}
                  </h3>
        ...
        <section className="py-16 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700 max-w-3xl mx-auto leading-relaxed">
                Proven automation playbooks that <strong className="text-orange-600">transform every customer touchpoint</strong>
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              {useCases.map((useCase, index) => (
                <div
                  key={index}
                  className="group bg-white border border-orange-200 p-6 hover:border-orange-400 shadow-md hover:shadow-lg hover:shadow-orange-200/50 transition-all duration-500 hover:-translate-y-2"
                  style={{
                    clipPath: 'polygon(0 0, calc(100% - 12px) 0, 100% 12px, 100% 100%, 12px 100%, 0 calc(100% - 12px))'
                  }}
                >
                  {/* HD Image */}
                  <div className="relative w-full h-32 mb-4 overflow-hidden border border-orange-200" style={{
                    clipPath: 'polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))'
                  }}>
                    <Image
                      src={useCase.image}
                  ...
                  <h3 className="text-xl font-bold mb-3 text-orange-600 group-hover:text-orange-700 transition-colors uppercase tracking-wider leading-tight">
                    {useCase.title}
                  </h3>
                  <p className="text-gray-700 text-xs leading-relaxed mb-4">
                    {useCase.description}
                  </p>
                  <span className="inline-flex items-center px-3 py-1.5 bg-orange-100 border border-orange-300 text-orange-700 text-xs font-semibold uppercase tracking-widest" style={{
                    clipPath: 'polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))'
                  }}>
        ...
        <section className="py-16 bg-gray-50 relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700 max-w-3xl mx-auto leading-relaxed">
                Deep technical capabilities that keep your contact center <strong className="text-orange-600">fast, compliant, and future-proof</strong>
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              {featureBlocks.map((feature, index) => (
                <div
                  key={index}
                  className="group bg-white border border-orange-200 p-6 hover:border-orange-400 shadow-md hover:shadow-lg hover:shadow-orange-200/50 transition-all duration-500"
                  style={{
                    clipPath: 'polygon(0 0, calc(100% - 12px) 0, 100% 12px, 100% 100%, 12px 100%, 0 calc(100% - 12px))'
                  }}
                >
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    <h3 className="text-lg font-bold text-orange-600 group-hover:text-orange-700 transition-colors uppercase tracking-wider leading-tight">
                      {feature.heading}
                    </h3>
                  </div>
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700 max-w-2xl mx-auto leading-relaxed">
                Experience how AI <strong className="text-orange-600">routes calls, verifies identities, and resolves requests</strong> with human-level empathy
              </p>
            </div>
            <div className="bg-white border border-orange-200 p-6 shadow-lg shadow-orange-100/20" style={{
              clipPath: 'polygon(0 0, calc(100% - 12px) 0, 100% 12px, 100% 100%, 12px 100%, 0 calc(100% - 12px))'
            }}>
        ...
        <section className="relative py-16 overflow-hidden bg-gray-50">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-20 -left-20 w-96 h-96 bg-gradient-radial from-orange-400/8 to-transparent rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-20 -right-20 w-[500px] h-[500px] bg-gradient-radial from-orange-300/6 to-transparent rounded-full blur-3xl animate-pulse delay-300" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-radial from-orange-400/5 to-transparent rounded-full blur-3xl animate-pulse delay-700" />
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-sm sm:text-base text-gray-700 max-w-3xl mx-auto leading-relaxed">
                Quick answers for leaders <strong className="text-orange-600">evaluating AI call center solutions</strong>
              </p>
            </div>
            ...
            <div className="max-w-5xl mx-auto grid gap-4">
              {faqSchema.mainEntity.map((faq, index) => (
                <div
                  key={index}
                  className="group relative bg-white border border-orange-200 p-6 hover:border-orange-400 shadow-md hover:shadow-lg hover:shadow-orange-200/50 transition-all duration-500"
                  style={{
                    clipPath: 'polygon(0 0, calc(100% - 12px) 0, 100% 12px, 100% 100%, 12px 100%, 0 calc(100% - 12px))'
                  }}
                >
                  <div className="flex gap-4">
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 bg-orange-500 text-white flex items-center justify-center font-bold text-sm shadow-md transition-transform duration-500 group-hover:scale-110" style={{
                        clipPath: 'polygon(0 0, calc(100% - 4px) 0, 100% 4px, 100% 100%, 4px 100%, 0 calc(100% - 4px))'
                      }}>
                        {index + 1}
                      </div>
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold mb-3 text-orange-600 group-hover:text-orange-700 transition-colors uppercase tracking-wider">
                        {faq.name}
                      </h3>
                      <p className="text-gray-700 text-xs leading-relaxed">
        ...
        <section className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 relative overflow-hidden">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute top-16 right-32 w-16 h-16 bg-gradient-to-br from-orange-300/20 to-orange-400/20 rounded-full blur-lg animate-pulse delay-500" />
          </div>

          <div className="container mx-auto max-w-4xl text-left relative z-10">
            <div className="inline-flex items-center gap-2 bg-orange-500 text-white px-3 py-1 mb-4 border border-orange-500 uppercase tracking-widest" style={{
              clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))'
            }}>
            ...
            <h2 className="text-lg sm:text-xl font-bold mb-3 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent uppercase tracking-wide">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <Link href="/signup">
                <button className="group relative bg-orange-500 hover:bg-orange-400 text-white px-6 py-2 text-sm font-bold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-400/30 border border-orange-500 uppercase tracking-wide w-full sm:w-auto flex justify-center items-center" style={{
                  clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))'
                }}>
                  Start Free Trial
              ...
              <Link href="/contact">
                <button className="group bg-white hover:bg-orange-50 text-orange-600 hover:text-orange-700 border border-orange-400/30 hover:border-orange-400 px-6 py-2 text-sm font-bold transition-all duration-300 backdrop-blur-md uppercase tracking-wide w-full sm:w-auto flex justify-center items-center" style={{
                  clipPath: 'polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px))'
                }}>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 text-xs text-gray-700">
              <div className="flex items-center gap-1 px-2 py-1 bg-orange-100 border border-orange-400/20 backdrop-blur-sm" style={{
                clipPath: 'polygon(0 0, calc(100% - 6px) 0, 100% 6px, 100% 100%, 6px 100%, 0 calc(100% - 6px))'
              }}>
