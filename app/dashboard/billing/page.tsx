  ...
  const handlePayment = async () => {
    ...
    const options = {
      ...
      handler: function (response: any) {
        ...
        // TODO: Update credits in backend
      },
      prefill: {
        name: "Customer Name",
        ...
        <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-8 transform transition-all animate-slideUp">
          ...
          <div className="space-y-3">
            <button 
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 text-white font-bold py-4 rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2"
            >
            ...
            <>
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-3xl font-bold bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 bg-clip-text text-transparent">
                      {userCredits.total - userCredits.used}
                    </span>
              ...
              <div className="grid grid-cols-3 gap-3 pt-4 border-t border-slate-200">
                ...
                <div className="text-center">
                  ...
                  <p className="text-base font-bold text-slate-900">{userCredits.total - userCredits.used}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl p-6 text-white shadow-xl">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <p className="text-3xl font-black">45.2h</p>
                ...
                <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-6 text-white shadow-xl">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <p className="text-3xl font-black">347</p>
              ...
              <div className="bg-white rounded-2xl border-2 border-slate-200 shadow-xl overflow-hidden mb-8">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody>
                      {[
                        { date: '2025-11-07 14:23', number: '+1 (555) 123-4567', duration: '12:45', type: 'Outbound', credits: 3, status: 'completed' },
                        { date: '2025-11-07 13:15', number: '+1 (555) 987-6543', duration: '8:30', type: 'Inbound', credits: 2, status: 'completed' },
                        { date: '2025-11-07 11:42', number: '+1 (555) 456-7890', duration: '15:22', type: 'Outbound', credits: 4, status: 'completed' },
                        { date: '2025-11-07 09:18', number: '+1 (555) 321-0987', duration: '5:10', type: 'Inbound', credits: 1, status: 'completed' },
                        { date: '2025-11-06 16:55', number: '+1 (555) 234-5678', duration: '20:15', type: 'Outbound', credits: 5, status: 'completed' },
                      ].map((call, idx) => (
                        <tr key={idx} className="border-b border-slate-200 hover:bg-slate-50 transition-colors">
                          <td className="px-6 py-4 text-sm font-medium text-slate-700">{call.date}</td>
                          <td className="px-6 py-4 text-sm font-bold text-slate-900">{call.number}</td>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm font-black text-green-600">35%</span>
                        </div>
                        <div className="bg-slate-200 rounded-full h-2">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-black text-purple-600">42%</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-slate-700 font-medium">Afternoon (12 PM - 5 PM)</span>
                        <span className="font-black text-purple-600">38%</span>
                      </div>
                      <div className="flex items-center justify-between">
