...
<div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16 animate-fade-in-up-2 pt-1 lg:pt-2">
    ...
    <div className="relative w-full flex items-center justify-center mb-2 sm:mb-4" style={{height: '60vw', maxHeight: '500px', minHeight: '350px', overflow: 'hidden'}}>
            ...
            <div className="relative flex items-center justify-center w-[85vw] max-w-[420px] h-[65vw] max-h-[380px] sm:w-[500px] sm:h-[420px] lg:w-[550px] lg:h-[480px]">
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className={` rounded-full transition-all duration-500 ${
                            isSpeaking
                                ? 'bg-cyan-500/40 blur-3xl animate-pulse shadow-[0_0_200px_rgba(0,255,255,0.6)]'
                                : 'bg-cyan-500/25 blur-3xl shadow-[0_0_80px_rgba(0,255,255,0.4)]'
                            }`}></div>
                    </div>
                    ...
                    <div className={`relative transition-all duration-500 ${isSpeaking ? 'scale-110' : 'scale-105'}`}>
                        <div
                            id="lottie-animation"
                            className="w-[75vw] h-[75vw] max-w-[380px] max-h-[380px] sm:w-[500px] sm:h-[420px] lg:w-[550px] lg:h-[480px]"
                            style={{
                                filter: isSpeaking
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            ...
                            >
                                ...
                                <div className="mb-1 relative z-10">
                                    <Mic className="h-5 w-5 sm:h-7 sm:w-7 drop-shadow-lg" />
                                </div>
